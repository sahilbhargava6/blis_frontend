    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 border-b border-slate-100 flex items-center justify-between px-8 bg-white/80 backdrop-blur-sm">
          <div>
            <h2 className="text-sm font-semibold text-slate-700 font-['Plus_Jakarta_Sans']">Welcome back,</h2>
            <p className="text-xs text-slate-400 font-['Roboto']">Super Administrator</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="h-2 w-2 rounded-full bg-[#0E76C0] animate-pulse"></span>
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider font-['Plus_Jakarta_Sans']">Live System</span>
          </div>
        </header>
