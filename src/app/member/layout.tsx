    ...
    <div className="flex min-h-screen bg-[#080b12]">
      ...
      <aside className="w-64 glass-panel border-r border-white/5 flex flex-col z-20">
        ...
        <div className="h-16 flex items-center gap-2.5 px-6 border-b border-white/5">
          ...
          <span className="font-extrabold tracking-tight text-white text-lg">BLIS Promoter</span>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 border-b border-white/5 flex items-center justify-between px-8 bg-slate-950/20 backdrop-blur-sm">
          <div>
            <h2 className="text-sm font-semibold text-slate-400">Promoter Hub</h2>
            <p className="text-xs text-slate-500">Gold Affiliate Network</p>
          </div>
          <div className="flex items-center gap-3">
            <span className="h-2 w-2 rounded-full bg-sky-500 animate-pulse"></span>
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Promoter Online</span>
          </div>
        </header>
