...
export default function MemberLinks() {
  ...
  const [generatedLink, setGeneratedLink] = useState('https://blisfrontend.vercel.app/api/v1/track/click/amazon_electronics_promo_usr_5');
  ...
  const handleGenerate = (e: React.FormEvent) => {
    ...
    setGeneratedLink(`https://blisfrontend.vercel.app/api/v1/track/click/${mockHash}_usr_5${queryString}`);
    setCopied(false);
  };
